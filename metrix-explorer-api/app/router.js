module.exports = app => {
  ...
  router.get(
    '/address/:address/mrc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.mrc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/txs-detail',
    addressMiddleware, paginationMiddleware, blockFilterMiddleware,
    controller.address.transactionsDetail
  )
  router.get(
  ...
  router.get(
    '/address/:address/mrc20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.mrc20TokenTransactions
  )
  router.get(
    '/address/:address/mrc20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.mrc20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/mrc20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.mrc20BalanceHistory
  )
  router.get(
    '/address/:address/mrc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.mrc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/mrc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.mrc20BalanceHistory
  )
  router.get(
    '/contract/:contract/mrc20-balance-history/:token',
  ...
  router.get(
    '/mrc20',
    paginationMiddleware,
    controller.mrc20.list
  )
  router.get(
    '/mrc20/txs',
    paginationMiddleware,
    controller.mrc20.allTransactions
  )
  router.get(
    '/mrc20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.mrc20.transactions
  )
  router.get(
    '/mrc20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.mrc20.richList
  )
  router.get(
    '/mrc721',
    paginationMiddleware,
    controller.mrc721.list
  )
