        ...
        <div class="table-body">
          <div v-for="tx in transactions">
            <div class="table-body-item">
              ...
              <div class="item-balance">{{ tx.balance | metrix(8) }}</div>
              <div class="item-amount">{{ tx.amount | metrix(8) }}</div>
            </div>
            <div class="mobile-body">
              ...
              <div class="item">
                ...
                <div class="content">{{ tx.balance | metrix(8) }}</div>
              </div>
              <div class="item">
                <div class="title">Balance Change (MRX)</div>
                <div class="content">{{ tx.amount | metrix(8) }}</div>
              </div>
            </div>
          </div>
        </div>
